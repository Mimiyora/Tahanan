...
<section class="directory-section">
    <div class="shell">
        ...
        <div class="table-card reveal reveal--late">
            <table id="user-table">
                <thead><tr><th>Team member</th><th>Username</th><th>Access role</th><th><span class="sr-only">Status</span></th></tr></thead>
                <tbody>
                <?php foreach ($users as $user): ?>
                    <tr>
                        <td data-label="Team member"><div class="identity"><span class="avatar avatar--green"><?= esc($user['initials']) ?></span><strong><?= esc($user['name']) ?></strong></div></td>
